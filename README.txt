...
executable python script.  This project has two separate goals:
...
The IDL files of each IPOL algorithms are stored on the directory
...
returns an array of m objects, and the numbers n and m are constant and fixed.
